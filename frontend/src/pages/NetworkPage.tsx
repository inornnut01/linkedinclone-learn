...
import type { ConnectionRequest, User as UserType } from "../types";
...
const NetworkPage = () => {
  ...
  const { data: connectionReqeuests } = useQuery({
    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
      ...
      <div className="col-span-1 lg:col-span-3">
        <div className="bg-secondary rounded-lg shadow p-6 mb-6">
          ...
          {connectionReqeuests?.length > 0 ? (
            <div className="mb-8">
              <h2 className="text-xl font-semibold mb-2">Connection Request</h2>
              <div className="space-y-4">
                {connectionReqeuests.map((request: ConnectionRequest) => (
